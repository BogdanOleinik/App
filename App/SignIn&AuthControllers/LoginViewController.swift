...
class LoginViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        googleButton.castomizeGoogleButton()
...
extension LoginViewController {
    private func setupConstraints() {
        ...
        let bottomStackView = UIStackView(arrangeSubviews: [needAnAccountLabel, signUpButton], axis: .horizontal, spacing: 10)
        ...
        NSLayoutConstraint.activate([
            welcomeLabel.topAnchor.constraint(lessThanOrEqualToSystemSpacingBelow: view.topAnchor, multiplier: view.frame.height / 100),
